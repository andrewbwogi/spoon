...
/*
    ...
    public void featurequestion() throws ClassNotFoundException {
        URLClassLoader loader = new URLClassLoader(urlClasspath(new String[]{"/home/andrewb/Desktop/spoon/class"}));
        Class kl = loader.loadClass("spoon.Launcher");
        ...
        /*for(URL u : ((StandardEnvironment)launcher.getEnvironment()).urlClasspath()){
        ...
        System.out.println(r2.getTypeDeclaration().isShadow());
